...
def _make_matches(image_dir: str,
    ...
    while curr_matches < total_matches:
        ...
        images = _clean_images(image_dir, person, format_style)
        if len(images) > 1:
            img1, img2 = sorted(
...
def _make_mismatches(image_dir: str,
    ...
    while curr_matches < total_matches:
        ...
        if person1 != person2:
            person1_images = _clean_images(image_dir, person1, format_style)
            person2_images = _clean_images(image_dir, person2, format_style)
