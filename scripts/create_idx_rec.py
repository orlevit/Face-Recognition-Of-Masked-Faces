...
from scripts.script_config import START_ENV, IDX_REC_FUNC, CASIA_PROPERTY, PROPERTY, CASIA_LST_FILE, LST_FILE
...
def make_idx_rec(input):
    ...
    os.system(f'{START_ENV} python {IDX_REC_FUNC} {input}')
