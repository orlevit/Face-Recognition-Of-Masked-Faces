...
def main(args):
     ...
     model_name = f'{pairs_num}pairs_{type(model).__name__}_lastHidden{layer_size}_lr{opt_params[0]}_{EMBBEDINGS_REDUCED}_{datetime.now().strftime("D%d_%m_%Y_T%H_%M_%S_%f")}'
