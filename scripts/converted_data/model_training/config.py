...
EPOCHS = 1000000
MIN_LOSS_SAVE = 0.3#float('-inf') # 0.5
...
# combinedV2
MODEL_VERSON = 'V2'
TRAIN_DATA_LOC = os.path.join('/RG/rg-tal/orlev/Face-Recognition-Of-Masked-Faces/scripts/prepare_run/bin/bins_files/train/combinedV2/all/20k_pairs', 'data.pt')
TRAIN_LABELS_LOC = os.path.join('/RG/rg-tal/orlev/Face-Recognition-Of-Masked-Faces/scripts/prepare_run/bin/bins_files/train/combinedV2/all/20k_pairs', 'labels.pt')
