...
PRELOADED_MODEL_LOC = os.path.join(MODELS_SAVE_PATH, '20000pairsV1_reduce8_seed42_NeuralNetwork15_lastHidden4096_lr1e-05_32_D27_06_2022_T19_34_34_794674.pt')
#TRAIN_DATA_LOC = os.path.join('/RG/rg-tal/orlev/Face-Recognition-Of-Masked-Faces/scripts/prepare_run/bin/bins_files/train/combinedV1/all/20k_pairs', 'data.pt')
#TRAIN_LABELS_LOC = os.path.join('/RG/rg-tal/orlev/Face-Recognition-Of-Masked-Faces/scripts/prepare_run/bin/bins_files/train/combinedV1/all/20k_pairs', 'labels.pt')
TRAIN_DATA_LOC = os.path.join('/home/orlev/work/Face-Recognition-Of-Masked-Faces/scripts/prepare_run/bin/bins_files/train/combinedV1/mask_nomask/combinedV1/10k_covid_unmask', 'data.pt')
TRAIN_LABELS_LOC = os.path.join('/home/orlev/work/Face-Recognition-Of-Masked-Faces/scripts/prepare_run/bin/bins_files/train/combinedV1/mask_nomask/combinedV1/10k_covid_unmask', 'lables.pt')
...
hsdict = {'lr': [np.power(10.0, -5)]}#,np.power(10.0, -3),5*np.power(10.0, -4),np.power(10.0, -5)]}
