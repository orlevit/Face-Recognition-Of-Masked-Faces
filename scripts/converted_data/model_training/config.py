...
TRAIN_DATA_LOC = os.path.join('/RG/rg-tal/orlev/Face-Recognition-Of-Masked-Faces/scripts/converted_data/train/db_bin_multi_masks_350000/all', 'data.pt')
TRAIN_LABELS_LOC = os.path.join('/RG/rg-tal/orlev/Face-Recognition-Of-Masked-Faces/scripts/converted_data/train/db_bin_multi_masks_350000/all', 'labels.pt')
...
hsdict = {'lr': [np.power(10.0, -2)]}#,np.power(10.0, -3),5*np.power(10.0, -4),np.power(10.0, -5)]}
