...
def parse_arguments():
    ...
    parser.add_argument('-m', '--model', type=int, help='Which model to create.')
...
def forward_bins_through_models(model_dir_loc, bins_dir_loc, image_size, batch_size, args):
...
forward_bins_through_models(MODEL_DIR_LOC, BIN_LOC, IMAGE_SIZE, BATCH_SIZE, args)
