...
START_MTCNN_ENV = 'source activate mtcnn;'
START_INSIGHT_ENV = 'source activate inssightface;'
...
BIN_FUNC = '/home/orlev/work/project/insightface_old/src/data/lfw2pack.py'
IDX_REC_FUNC = '/home/orlev/work/project/insightface_old/src/data/face2rec2.py'
